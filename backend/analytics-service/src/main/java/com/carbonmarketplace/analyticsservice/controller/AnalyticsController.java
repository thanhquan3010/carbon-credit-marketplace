...
public class AnalyticsController {
    ...
    @Operation(summary = "Get executive dashboard data", description = "Returns real-time executive dashboard metrics with 15-minute refresh")
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'EXECUTIVE')")
    @Operation(summary = "Get real-time metrics", description = "Returns current real-time platform metrics")
    ...
    @Operation(summary = "Get KPI metrics", description = "Returns KPI metrics for specified period and category")
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'EXECUTIVE', 'ANALYST')")
    @Operation(summary = "Get metric trends", description = "Returns trend analysis for specified metric")
    ...
    @Operation(summary = "Get user analytics", description = "Returns analytics for specific user")
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'EXECUTIVE', 'ANALYST')")
    @Operation(summary = "Generate custom report", description = "Generates custom report based on provided criteria")
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'EXECUTIVE', 'ANALYST')")
    @Operation(summary = "Download report", description = "Downloads generated report in specified format")
    public ResponseEntity<byte[]> downloadReport(
        ...
        headers.setContentType(
                format.equalsIgnoreCase("PDF") ? MediaType.APPLICATION_PDF : MediaType.APPLICATION_OCTET_STREAM);
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'EXECUTIVE', 'ANALYST')")
    @Operation(summary = "Get report templates", description = "Returns available report templates")
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'EXECUTIVE')")
    @Operation(summary = "Get marketplace metrics", description = "Returns marketplace performance metrics")
    ...
    @Operation(summary = "Get environmental impact metrics", description = "Returns environmental impact and CO2 offset metrics")
    ...
    @Operation(summary = "Manually refresh analytics", description = "Triggers manual refresh of analytics and materialized views")
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "Get performance bottlenecks", description = "Identifies system performance bottlenecks")
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'EXECUTIVE')")
    @Operation(summary = "Get metric forecast", description = "Returns forecasted values for specified metric")
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'EXECUTIVE', 'ANALYST')")
    @Operation(summary = "Get cohort analysis", description = "Returns cohort analysis for user retention and behavior")

    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("1.0.0")
                        .description("Carbon Credit Verification Service for CVA auditors to review and approve verification requests")
                        .contact(new Contact()
                ...
                .servers(List.of(
                        ...
                        new Server().url("https://api.carbonmarketplace.com/verification").description("Production")))
